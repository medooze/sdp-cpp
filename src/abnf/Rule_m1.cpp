      ...
      for (int i1 = 0; i1 < 1 && f1; i1++)
      {
        ...
        parsed = false;
        {
          ...
          if (parsed)
          {
            ...
            {
              const Rule* rule = Terminal_StringValue::parse(context, "22");
              if ((f2 = rule != NULL))
              {
            ...
            for (int i2 = 0; i2 < 1 && f2; i2++)
            {
              ...
              }
              {
                ...
                if (parsed)
                {
                  ...
                  for (int i3 = 0; i3 < 1 && f3; i3++)
                  {
                    const Rule* rule = Terminal_StringValue::parse(context, "5");
                    if ((f3 = rule != NULL))
                    {
                      a3.add(*rule, context.index);
                      c3++;
              ...
              }
              {
                ...
                if (parsed)
                {
                  ...
                  for (int i3 = 0; i3 < 1 && f3; i3++)
                  {
                    const Rule* rule = Terminal_StringValue::parse(context, "6");
                    if ((f3 = rule != NULL))
                    {
                      a3.add(*rule, context.index);
                      c3++;
              ...
              }
              {
                ...
                if (parsed)
                {
                  ...
                  for (int i3 = 0; i3 < 1 && f3; i3++)
                  {
                    const Rule* rule = Terminal_StringValue::parse(context, "7");
                    if ((f3 = rule != NULL))
                    {
                      a3.add(*rule, context.index);
                      c3++;
              ...
              }
              {
                ...
                if (parsed)
                {
                  ...
                  for (int i3 = 0; i3 < 1 && f3; i3++)
                  {
                    const Rule* rule = Terminal_StringValue::parse(context, "8");
                    if ((f3 = rule != NULL))
                    {
                      a3.add(*rule, context.index);
                      c3++;
              ...
              }
              {
                ...
                if (parsed)
                {
                  ...
                  for (int i3 = 0; i3 < 1 && f3; i3++)
                  {
                    const Rule* rule = Terminal_StringValue::parse(context, "9");
                    if ((f3 = rule != NULL))
                    {
                      a3.add(*rule, context.index);
                      c3++;
      ...
      for (int i1 = 0; i1 < 1 && f1; i1++)
      {
        ...
        parsed = false;
        {
          ...
          if (parsed)
          {
            ...
            for (int i2 = 0; i2 < 1 && f2; i2++)
            {
              const Rule* rule = Terminal_StringValue::parse(context, "23");
              if ((f2 = rule != NULL))
              {
                a2.add(*rule, context.index);
                c2++;
