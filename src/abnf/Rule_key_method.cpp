...
const Rule_key_method* Rule_key_method::clone() const
{
  return new Rule_key_method(this->spelling, this->rules);
}

void* Rule_key_method::accept(Visitor& visitor) const
{
  return visitor.visit(this);
}

const Rule_key_method* Rule_key_method::parse(ParserContext& context)
{
