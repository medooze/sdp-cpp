...
Rule* Rule_local_part::clone() const
{
  return new Rule_local_part(this->spelling, this->rules);
}

void* Rule_local_part::accept(Visitor& visitor)
{
  return visitor.visit(this);
}

Rule_local_part* Rule_local_part::parse(ParserContext& context)
{
  ...
  }
  {
    ...
    if (parsed)
    {
      bool f1 = true;
      int c1 = 0;
      Rule* rule = Rule_obs_local_part::parse(context);
      if ((f1 = rule != NULL))
      {
        a1.add(rule, context.index);
        c1++;
