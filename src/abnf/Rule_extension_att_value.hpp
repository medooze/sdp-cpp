...
{
public:
  Rule_extension_att_value(const std::string& spelling, const std::vector<const Rule*>& rules);
  ...
  const Rule_extension_att_value* clone(void) const;

  static const Rule_extension_att_value* parse(ParserContext& context);
