...
Rule* Rule_time_fields::clone() const
{
  return new Rule_time_fields(this->spelling, this->rules);
}

void* Rule_time_fields::accept(Visitor& visitor)
{
  return visitor.visit(this);
}

Rule_time_fields* Rule_time_fields::parse(ParserContext& context)
{
      ...
      for (int i1 = 0; i1 < 1 && f1; i1++)
      {
        ...
        parsed = false;
        {
          ...
          if (parsed)
          {
            bool f2 = true;
            int c2 = 0;
            Rule* rule = Rule_time_repeat_field::parse(context);
            if ((f2 = rule != NULL))
            {
