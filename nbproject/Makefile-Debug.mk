...
${OBJECTDIR}/src/abnf/Displayer.o: src/abnf/Displayer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/abnf/Displayer.o src/abnf/Displayer.cpp
...
${OBJECTDIR}/src/abnf/XmlDisplayer.o: src/abnf/XmlDisplayer.cpp
	${MKDIR} -p ${OBJECTDIR}/src/abnf
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/abnf/XmlDisplayer.o src/abnf/XmlDisplayer.cpp

${OBJECTDIR}/src/builders/AttributeBuilder.o: src/builders/AttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/AttributeBuilder.o src/builders/AttributeBuilder.cpp

${OBJECTDIR}/src/builders/BandwitdhBuilder.o: src/builders/BandwitdhBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/BandwitdhBuilder.o src/builders/BandwitdhBuilder.cpp

${OBJECTDIR}/src/builders/BaseAttributeBuilder.o: src/builders/BaseAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/BaseAttributeBuilder.o src/builders/BaseAttributeBuilder.cpp
...
${OBJECTDIR}/src/builders/CNameAttributeBuilder.o: src/builders/CNameAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/CNameAttributeBuilder.o src/builders/CNameAttributeBuilder.cpp

${OBJECTDIR}/src/builders/CandidateAttributeBuilder.o: src/builders/CandidateAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/CandidateAttributeBuilder.o src/builders/CandidateAttributeBuilder.cpp

${OBJECTDIR}/src/builders/ConnectionBuilder.o: src/builders/ConnectionBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/ConnectionBuilder.o src/builders/ConnectionBuilder.cpp

${OBJECTDIR}/src/builders/CryptoAttributeBuilder.o: src/builders/CryptoAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/CryptoAttributeBuilder.o src/builders/CryptoAttributeBuilder.cpp

${OBJECTDIR}/src/builders/ExtMapAttributeBuilder.o: src/builders/ExtMapAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/ExtMapAttributeBuilder.o src/builders/ExtMapAttributeBuilder.cpp

${OBJECTDIR}/src/builders/FingerprintAttributeBuilder.o: src/builders/FingerprintAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/FingerprintAttributeBuilder.o src/builders/FingerprintAttributeBuilder.cpp

${OBJECTDIR}/src/builders/FormatAttributeBuilder.o: src/builders/FormatAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/FormatAttributeBuilder.o src/builders/FormatAttributeBuilder.cpp

${OBJECTDIR}/src/builders/GroupAttributeBuilder.o: src/builders/GroupAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/GroupAttributeBuilder.o src/builders/GroupAttributeBuilder.cpp

${OBJECTDIR}/src/builders/InformationBuilder.o: src/builders/InformationBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/InformationBuilder.o src/builders/InformationBuilder.cpp

${OBJECTDIR}/src/builders/KeyBuilder.o: src/builders/KeyBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/KeyBuilder.o src/builders/KeyBuilder.cpp

${OBJECTDIR}/src/builders/MediaDescriptionBuilder.o: src/builders/MediaDescriptionBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/MediaDescriptionBuilder.o src/builders/MediaDescriptionBuilder.cpp

${OBJECTDIR}/src/builders/MidAttributeBuilder.o: src/builders/MidAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/MidAttributeBuilder.o src/builders/MidAttributeBuilder.cpp

${OBJECTDIR}/src/builders/OriginBuilder.o: src/builders/OriginBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/OriginBuilder.o src/builders/OriginBuilder.cpp

${OBJECTDIR}/src/builders/PreviousSSRCAttributeBuilder.o: src/builders/PreviousSSRCAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/PreviousSSRCAttributeBuilder.o src/builders/PreviousSSRCAttributeBuilder.cpp

${OBJECTDIR}/src/builders/RTPMapAttributeBuilder.o: src/builders/RTPMapAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/RTPMapAttributeBuilder.o src/builders/RTPMapAttributeBuilder.cpp

${OBJECTDIR}/src/builders/SCTPMapAttributeBuilder.o: src/builders/SCTPMapAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/SCTPMapAttributeBuilder.o src/builders/SCTPMapAttributeBuilder.cpp

${OBJECTDIR}/src/builders/SSRCAttributeBuilder.o: src/builders/SSRCAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/SSRCAttributeBuilder.o src/builders/SSRCAttributeBuilder.cpp

${OBJECTDIR}/src/builders/SSRCGroupAttributeBuilder.o: src/builders/SSRCGroupAttributeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/SSRCGroupAttributeBuilder.o src/builders/SSRCGroupAttributeBuilder.cpp
...
${OBJECTDIR}/src/builders/SessionNameBuilder.o: src/builders/SessionNameBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/SessionNameBuilder.o src/builders/SessionNameBuilder.cpp

${OBJECTDIR}/src/builders/TimeBuilder.o: src/builders/TimeBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}/src/builders
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/builders/TimeBuilder.o src/builders/TimeBuilder.cpp
